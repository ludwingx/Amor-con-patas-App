...
<body>
    <!-- Modal fuera de la barra lateral -->
    <div class="modal fade modal-fullscreen" id="notificationModal" tabindex="-1000"  role="dialog" aria-hidden="true">
    ...
    <div  class="height-100 bg-light content-container">
        <div id="body-pd">
